...
if ( ! class_exists( 'GTW_Settings' ) ) {
	...
	class GTW_Settings {
		 ...
		 * Plugin slug.
		 */
		private static $plugin_slug = 'gtw' ;
		...
		public static function get_settings_pages() {
			...
			include_once GTW_PLUGIN_PATH . '/inc/abstracts/class-gtw-settings-page.php' ;
		...
		public static function output_fields( $value ) {
			...
			if ( ! isset( $value[ 'type' ] ) || 'gtw_custom_fields' != $value[ 'type' ] ) {
				return ;
			}
			...
			$custom_attributes = gtw_format_custom_attributes( $value ) ;
					...
					<tr valign="top">
						...
						<td>
							<button
								...
								type="<?php echo esc_attr( $value[ 'gtw_field' ] ) ; ?>"
		...
		public static function save_fields( $value, $option, $raw_value ) {
			...
			if ( ! isset( $option[ 'type' ] ) || 'gtw_custom_fields' != $option[ 'type' ] ) {
				return $value ;
			}
